...
FOLDER_PREFIX = 'C:/Users/vk046010/Cerner Corporation/OneDrive - Cerner Corporation/Projects/AP_ASSIGNMENT2/IMG_Reco/python_scripts/training/'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default=FOLDER_PREFIX+'image_data',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default=FOLDER_PREFIX+'output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default=FOLDER_PREFIX+'intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default=FOLDER_PREFIX+'output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=FOLDER_PREFIX+'retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default=FOLDER_PREFIX+'imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default=FOLDER_PREFIX+'bottleneck',
